    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 380 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h1 style={{ fontSize: 22, fontWeight: 600 }}>Nebula Tracker</h1>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: 17, fontWeight: 600, marginBottom: 20 }}>Create your account</h2>
          ...
          <form onSubmit={submit}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <div>
                ...
                <input
                  type="text" required placeholder="Ravi Kumar"
                  value={form.name}
